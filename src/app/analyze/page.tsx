                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-8 bg-gray-800 rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full h-32 p-3 bg-gray-700 border border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500 text-white"
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 disabled:bg-gray-600"
                        >
